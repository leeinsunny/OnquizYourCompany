-- Update handle_new_user function to set default role as member
-- Only first user of company gets super_admin, all others start as member
...
begin
  ...
  -- Only first user gets super_admin, all others start as member
